...
static func create_cat_feed_widgets(parent: Control) -> Dictionary:
	...
	var cat_feed_area: Panel = Panel.new()
	...
	var cat_reaction_label: Label = Label.new()
	...
	var leftover_food_panel: Panel = Panel.new()
	...
	var leftover_food_container: HBoxContainer = HBoxContainer.new()
